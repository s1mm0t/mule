...
public class DefaultExtensionManagerTestCase extends AbstractMuleTestCase
{
    ...
    public void registerSameExtensionMultipleTimesButOnlyKeepOne()
    {
        ...
        assertThat(extensionsManager.getExtensions(), hasSize(3));
    }
    ...
    public void registerFromManifest() throws Exception
    {
        ...
        builder.withDescriber()
                .setId(AnnotationsBasedDescriber.DESCRIBER_ID)
                .addProperty(AnnotationsBasedDescriber.TYPE_PROPERTY_NAME, HeisenbergExtension.class.getName());
